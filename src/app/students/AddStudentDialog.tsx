    ...
    <>
      ...
      <Modal isOpen={isOpen} onClose={() => setIsOpen(false)} title="Add New Student" size="wide">
        <form onSubmit={handleSubmit} className="bg-gray-100/30 -m-8 p-8 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input name="email" type="email" className="w-full px-5 py-3.5 bg-white border-2 border-slate-300 rounded-xl font-bold text-slate-900 outline-none focus:border-primary-500 pl-10 text-sm" placeholder="parent@example.com" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-10">
              <div className="bg-white rounded-[2rem] p-8 shadow-sm border-2 border-slate-200 space-y-6">
                <div className="flex items-center gap-3 border-b-2 border-slate-50 pb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-black text-slate-900 tracking-tight">Guardian & Schedule</h3>
                  </div>
                </div>
                ...
                <div className="space-y-5">
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-[11px] font-black text-slate-700 uppercase tracking-wider">Parent Name</label>
                    ...
                    <div className="space-y-2">
                      <label className="text-[11px] font-black text-slate-700 uppercase tracking-wider">Region</label>
                      <div className="relative">
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-[11px] font-black text-slate-700 uppercase tracking-wider">Start Date <Req /></label>
                      <WheelDateInput value={startDate} onChange={setStartDate} name="startDate" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-[11px] font-black text-slate-700 uppercase tracking-wider">Duration <Req /></label>
                      <input name="lessonDuration" type="number" required defaultValue="45" className="w-full px-5 py-3.5 bg-white border-2 border-slate-300 rounded-xl font-black text-slate-900 outline-none text-sm" />
                    </div>
                  </div>

                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="text-[11px] font-black text-slate-700 uppercase tracking-wider">Venue <Req /></label>
                      <input name="venueInfo" required className="w-full px-5 py-3.5 bg-white border-2 border-slate-300 rounded-xl font-bold text-slate-900 outline-none text-sm" placeholder="Location" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-[11px] font-black text-slate-700 uppercase tracking-wider">Coach <Req /></label>
                      <div className="relative">
                        <select name="coachId" required className="w-full px-5 py-3.5 bg-white border-2 border-slate-300 rounded-xl font-bold text-slate-900 outline-none appearance-none text-sm">
          ...
          {/* 3. Bottom Section - Highly Compressed */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pt-4 border-t-2 border-slate-200">
            ...
            <div className="space-y-2 lg:col-span-1">
              <label className="text-[11px] font-black text-slate-700 uppercase tracking-wider">Notes</label>
